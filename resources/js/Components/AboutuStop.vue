            ...
            <div class="container">
                <div class="aboutustop_wrapper flex justify-between">
                    ...
                    <div class="whoWeAre_box2">
                        ...
                        <div class="videopopup_wrapper flex mb-4 items-center justify-between" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="videopopup_box2">
                                <div class="videopopup_box2_wrapper flex items-center gap-2">
                                    <div class="videopopup_box2_img_holder">
                                        <img src="/assets/img/arrow-rightred.png" width="10" height="7" alt="" />
                                    </div>
                                    <div class="videopopup_box2_text">
                        ...
                        <div class="aboutustop_cto flex items-center gap-3" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="aboutustop_cto_box2">
                                <h1 class="aboutustop_cto_box2_heading">Ahmed Abdala</h1>
                                <div class="aboutustop_cto_box2_desc">CTO, Of Company</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="whoWeAre_services_wrapper whoWeAre_services_wrapper--about flex items-center">
                    ...
                    <div class="whoWeAre_services_box_content">
                        <h1 class="whoWeAre_services_box_heading">500</h1>
                        <div class="whoWeAre_services_box_desc">
                        Team Members
                        </div>
                    </div>
                    ...
                    <div class="whoWeAre_services_box_content">
                        <h1 class="whoWeAre_services_box_heading">230</h1>
                        <div class="whoWeAre_services_box_desc">
                        Clients Are Happy
                        </div>
                    </div>
                    ...
                    <div class="whoWeAre_services_box_content">
                        <h1 class="whoWeAre_services_box_heading">3</h1>
                        <div class="whoWeAre_services_box_desc">
                        Award Wins
                        </div>
                    </div>
