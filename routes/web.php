...
Route::get('/team-details/{id}', [PagesController::class, 'teamDetails'])->name('team-details');
Route::get('/projects', [PagesController::class, 'projects'])->name('projects');
Route::get('/project-details/{id}', [PagesController::class, 'projectDetails'])->name('project-details');
